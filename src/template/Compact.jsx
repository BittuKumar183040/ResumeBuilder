...
const Builder = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="resume-page">
      <div className="aspect-[1/1.414] pl-8 pt-8 pr-8 pb-4 flex flex-col w-full max-w-198.5 max-h-280.75 overflow-hidden">
        <section className='flex flex-col items-center gap-2'>
          ...
          <div className="flex gap-4 text-sm">
            <p className="font-medium">+91-7563872977</p>

            <div className='flex gap-1.5 items-center'>
              <MailFilled />
              <p className="font-medium">bk183040@gmail.com</p>
            </div>

            <div className='flex gap-1.5 items-center'>
              <LinkedinFilled />
              <a className='font-medium' href="https://www.linkedin.com/in/bittukumar183040"
                target="_blank"
        ...
        <section>
          ...
          <div>
            ...
            <div className='flex justify-between text-xs mb-1'>
              <p className="font-md">BosonQ Psi Technology Pvt. Ltd.</p>
              <p className="italic">Remote + Hybrid, Bangalore</p>
            </div>

            <ol className='list-disc pl-5 space-y-1 text-sm ml-4'>
              <li>
                Developed a <span className="font-semibold">full-stack microservices-based simulation platform </span>
                using React, Spring Boot, and FastAPI, supporting secure storage
                (<span className="font-semibold">S3, PVC</span>), versioning, multi-tenancy, and API access control.
              </li>

              <li>
                Designed and built a <span className="font-semibold">2D/3D visualization engine </span>
                using WebGL and Three.js.
              </li>

              <li>
                Implemented <span className="font-semibold">JWT-based authentication</span> with bcrypt,
                enabling role-based access control.
              </li>

              <li>
                Built <span className="font-semibold">RESTful APIs</span> across microservices using
                FastAPI and Spring Boot with OpenAPI.
              </li>

              <li>
                Crafted a <span className="font-semibold">responsive UI</span> using React, Redux,
                TypeScript, and Tailwind CSS.
              </li>
              <li>
                Maintained high code quality through <span className="font-semibold">modular architecture</span>,
                unit and integration testing.
              </li>

              <li>
                Designed PostgreSQL schemas with <span className="font-semibold">ORM-based migrations </span>
                and efficient data-access patterns.
              </li>

              <li>
                Containerized and deployed services using <span className="font-semibold">Podman and Docker </span>
                on AWS with exposure to Kubernetes and GitOps.
              </li>
            </ol>
          </div>
        ...
        <section>
          ...
          <section>
            ...
            <ol className='list-disc pl-5 space-y-1 ml-4 text-sm'>
              ...
              <li>Implemented <span class="font-semibold">Object as S3 and PVC </span>for PnP migration for my storage solution.</li>
              <li>
